        ...
        <Row>
          <Col sm={8} lg={8} className="section-title-wrapper">
            ...
            >
              ...
              <h1>
                Representing <span>every</span> service meshes
              </h1>
            </SectionTitle>
            <p>
              The Layer5 community represents the largest collection of service meshes projects and their maintainers all around the world.
            </p>
